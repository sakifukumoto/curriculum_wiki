...
- **Spring Bootのよくある落とし穴を自分で調査・修正できる**
...
| [課題2-6](task-2-6-thymeleaf.md) | Thymeleaf（最低限の画面） | 🟡 Step1〜3形式 |
| [課題2-7](task-2-7-debug.md) | **デバッグ課題（壊れたコードを直す）** | 🔴 調査・修正 |
